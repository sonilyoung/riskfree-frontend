...
function SafetyUpload({ open, onClose, onInputChange, onUpload, onDownload, enableDownload, selectedFileName}) {
            ...
            <div className={open ? classes.uploadPopup : classes.popupClose}>
                <div className={classes.uploadPopup}>
                    ...
                    <div className={classes.uploadInfo}>
                        <span className={classes.topSpan}>개선조치 현황 업로드 관리</span>
