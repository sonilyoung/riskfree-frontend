...
const RegButton = styled(ButtonUnstyled)`
    border: none;
    width: 140px;
    height: 50px;
    display: flex;
...
const CorrectButton = styled(ButtonUnstyled)`
    border: none;
    width: 140px;
    height: 50px;
    display: flex;
...
const CancelRegButton = styled(ButtonUnstyled)`
    border: none;
    width: 140px;
    height: 50px;
    display: flex;
        ...
        <DefaultLayout>
            <Grid className={classes.pageWrap} container rowSpacing={0} columnSpacing={0}>
                ...
                <Grid item xs={12} className={classes.footerButtons}>
                    ...
                    <CorrectButton>수정</CorrectButton>
                    <CancelRegButton>취소</CancelRegButton>
                </Grid>
            </Grid>
        </DefaultLayout>
    );
