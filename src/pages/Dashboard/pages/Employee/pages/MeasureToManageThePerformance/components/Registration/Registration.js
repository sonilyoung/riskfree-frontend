                    ...
                    <div className={classes.boxRow}>
                        ...
                        <div className={classes.tableBody}>
                            ...
                            <div className={classes.tableRow}>
                                ...
                                <div className={classes.tableData}>제5조제1항</div>
                                <div className={classes.tableData}>3. 제5조제1항 전단에 따른 등록을 하지 아니하고 용기등을 제조한 자</div>
                                <div className={classes.tableData}>제5조(용기ㆍ냉동기 및 특정설비의 제조등록 등) 용기ㆍ냉동기 또는 특정설비특정설비의 제조등록 등) 용기ㆍ냉동기 또는 특정설비특정설비의 제조등록 등) 용기ㆍ냉동기 또는 특정설비(이하 "용기등"이라 한다)를 제조하려는 자는 시장ㆍ군수 또는 구청장에게 등록하여야 한다. </div>
                                <div className={classes.tableData}>
                                    <div className={classes.textAreaWrap}>
                                        <TextField
                                            className={classes.textArea}
                                            ...
                                            multiline
                                            rows={5}
                                            placeholder="위험성평가 유해ㆍ  위험요인을 확인하여 개선하는 업무절차를 마련하였음."
                                        />
                                    </div>
                                </div>
                            </div>
