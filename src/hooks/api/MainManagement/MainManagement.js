...
export const { useGetWorkplaceListMutation, useGetLoginInfoMutation, useGetLeaderImprovementListMutation, useGetAccidentTotalMutation, useGetSafeWorkHistoryListMutation } = mainManagement;